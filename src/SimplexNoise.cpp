 ...
 */
static float
grad(int32_t hash, float x, float y)
{
 ...
 */
static float
grad(int32_t hash, float x, float y, float z)
{
 ...
 */
float
SimplexNoise::noise(float x, float y)
{
 ...
 */
float
SimplexNoise::noise(float x, float y, float z)
{
 ...
 */
float
SimplexNoise::fractal(size_t octaves, float x) const
{
  float output    = 0.f;
  float denom     = 0.f;
 ...
 */
float
SimplexNoise::fractal(size_t octaves, float x, float y) const
{
  float output    = 0.f;
  float denom     = 0.f;
  float frequency = mFrequency;
 ...
 */
float
SimplexNoise::fractal(size_t octaves, float x, float y, float z) const
{
  float output    = 0.f;
  float denom     = 0.f;
  float frequency = mFrequency;

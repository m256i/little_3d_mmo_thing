...
static inline void
wrenCallFunction(WrenVM* vm, ObjFiber* fiber, ObjClosure* closure, int numArgs)
{
...
wrenGetClassInline(WrenVM* vm, Value value)
{
...
// letter).
static inline bool
wrenIsLocalName(const char* name)
{
  return name[0] >= 'a' && name[0] <= 'z';
}

static inline bool
wrenIsFalsyValue(Value value)
{

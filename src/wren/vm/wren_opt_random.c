...
wrenRandomBindForeignClass(WrenVM* vm, const char* module, const char* className)
{
...
WrenForeignMethodFn
wrenRandomBindForeignMethod(WrenVM* vm, const char* className, bool isStatic, const char* signature)
{
  ASSERT(strcmp(className, "Random") == 0, "Should be in Random class.");
